...
export const dummyUsers: AppUser[] = [
  ...
  { ...base, uid: "u2", email: "t.yamada@rc-group.co.jp", displayName: "山田 太郎", photoURL: null, departmentId: "dept-exec", departmentName: "経営管理部", role: "staff", joinedAt: j(2019, 4), birthday: "03-05", createdAt: ago(30 * day), updatedAt: ago(2 * day) },
  { ...base, uid: "u3", email: "t.tanaka@rc-group.co.jp", displayName: "田中 達也", photoURL: null, departmentId: "dept-sales", departmentName: "営業部", role: "manager", joinedAt: j(2020, 1), birthday: "11-23", createdAt: ago(30 * day), updatedAt: ago(3 * day) },
  { ...base, uid: "u4", email: "m.takahashi@rc-group.co.jp", displayName: "高橋 美穂", photoURL: null, departmentId: "dept-sales", departmentName: "営業部", role: "staff", joinedAt: j(2021, 4), birthday: "06-18", createdAt: ago(30 * day), updatedAt: ago(4 * day) },
  { ...base, uid: "u5", email: "k.kobayashi@rc-group.co.jp", displayName: "小林 健太", photoURL: null, departmentId: "dept-sales", departmentName: "営業部", role: "staff", joinedAt: j(2022, 4), birthday: "02-28", createdAt: ago(30 * day), updatedAt: ago(5 * day) },
  { ...base, uid: "u6", email: "h.suzuki@rc-group.co.jp", displayName: "鈴木 花子", photoURL: null, departmentId: "dept-dev", departmentName: "開発部", role: "staff", joinedAt: j(2023, 4), birthday: "09-09", createdAt: ago(30 * day), updatedAt: ago(6 * day) },
  { ...base, uid: "u7", email: "s.nakamura@rc-group.co.jp", displayName: "中村 さくら", photoURL: null, departmentId: "dept-dev", departmentName: "開発部", role: "staff", joinedAt: j(2024, 4), birthday: "04-01", createdAt: ago(30 * day), updatedAt: ago(7 * day) },
  { ...base, uid: "u8", email: "t.matsumoto@rc-group.co.jp", displayName: "松本 拓也", photoURL: null, departmentId: "dept-dev", departmentName: "開発部", role: "staff", joinedAt: j(2024, 4), birthday: "12-31", createdAt: ago(30 * day), updatedAt: ago(8 * day) },
  { ...base, uid: "u9", email: "m.ito@rc-group.co.jp", displayName: "伊藤 美咲", photoURL: null, departmentId: "dept-hr", departmentName: "人事・総務部", role: "staff", joinedAt: j(2025, 4), birthday: "08-15", createdAt: ago(30 * day), updatedAt: ago(9 * day) },
  { ...base, uid: "u10", email: "k.sato@rc-group.co.jp", displayName: "佐藤 健一", photoURL: null, departmentId: "dept-hr", departmentName: "人事・総務部", role: "staff", joinedAt: j(2025, 10), birthday: "05-22", createdAt: ago(30 * day), updatedAt: ago(10 * day) },
];
